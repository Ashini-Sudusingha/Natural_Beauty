...
<body>
  ...
  <div class="mt-8 bg-gradient-to-tr from-rose-200 to-pink-300">
    <div class="mx-auto w-full max-w-[1166px] px-4 xl:px-0 ">
      <div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
        <div class="md:w-[316px]">
          ...
          <img src="resoses/images/resizelogo.png">
          
          </p>
          <p class="mt-[18px] text-[15px] font-normal text-black">Discover the best in beauty at our store. From skincare to makeup, we offer premium products to enhance your natural glow. Enjoy exclusive deals, expert tips, and exceptional customer service. 
            Shop now for a radiant, confident you! Follow us on social media for the latest updates..</p>
          <div class="mt-[18px] flex gap-4">
            <a class="hover:scale-110" target="_blank"
              href="#"><img alt="facebook icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="https://img.icons8.com/?size=100&id=uLWV5A9vXIPu&format=png&color=000000" /></a><a
              class="hover:scale-110" target="_blank"
              href="/"><img alt="linkdin icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="https://img.icons8.com/?size=100&id=Xy10Jcu1L2Su&format=png&color=000000" /></a><a
              class="hover:scale-110" target="_blank"
              href="/"><img alt="instagram icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="https://img.icons8.com/?size=100&id=118638&format=png&color=000000" /></a><a
              class="hover:scale-110" target="_blank"
              href=""><img alt="twitter icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="https://img.icons8.com/?size=100&id=5MQ0gPAYYx7a&format=png&color=000000" /></a><a
              class="hover:scale-110" target="_blank"
              href="https://www.youtube.com/"><img alt="youtube icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="https://img.icons8.com/?size=100&id=19318&format=png&color=000000" /></a>
          </div>
        </div>
        <div class="md:w-[316px]">
          <div class="mt-[23px] flex">
            ...
            <div class="ml-[18px]">
              <a href="tel:+911800123444" class="font-Inter text-[14px] font-medium text-black">+9767749516</a>
          ...
          <div class="mt-[23px] flex">
            ...
            <div class="ml-[18px]">
              <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium text-black">naturalbeautygirl@gmail.com</a>
          ...
          <div class="mt-[23px] flex">
            ...
            <div class="ml-[18px]">
              <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium text-black">Sulthnagoda,Clombo 8,Sri Lanka</a>
        ...
        <div class="mt-6 flex w-full flex-col justify-between text-black sm:flex-row md:mt-0 md:max-w-[341px]">
          <div class="">
            ...
            <ul>
              ...
              <li class="mt-[15px]"><a
                  class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                  href="/our-tutors">Cosmatic</a></li>
              <li class="mt-[15px]"><a
                  class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                  href="/become-a-tutor">Sikn</a></li>
              <li class="mt-[15px]"><a
                  class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                  href="/plans-and-pricing">Uesr profile</a></li>
              <li class="mt-[15px]"><a
                  class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                  href="/terms-and-conditions">whatch List</a></li>
              <li class="mt-[15px]"><a
                  class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                  href="/privacy-policy">Cart</a></li>
            </ul>
          </div>
          <div class="flex flex-col gap-4 mt-6 sm:mt-0">
            ...
            <div class="flex gap-4 sm:flex-col">
              <a target="_blank"
                href="#"><img alt="facebook icon" loading="lazy" width="168" height="50" decoding="async" data-nimg="1" style="color:transparent" src="resoses/images/footer.png" /></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center justify-center pb-8 pt-[9px] md:py-8">
        <p class="text-[10px] font-normal text-black md:text-[12px]">
          © Copyright
          <!-- -->2024
          <!-- -->, All Rights Reserved by NATURAL BEAUTY. PVT. LTD
        </p>
      </div>
    </div>
  </div>
