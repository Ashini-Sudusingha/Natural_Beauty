...
ORDER BY `product`.`categroy_cat_id`='3' ASC";
...
?>
  <div class="w-screen p-5 mt-10 bg-white rounded-lg">
   <div class= "grid grid-cols-3 ">
    ...
    <img src="resoses/images/fragrence2.jpeg" width="400" height="400"/>
    </div>

    <div class="col-span-1 ">
    <p class="text-2xl font-bold font-moon">Habbit for Your Skin</p>
    <div class="p-3 font-mono text-3xl font-extrabold bg-rose-300">SKIN CARE</div>
    <img src="resoses/images/fragrance1.jpeg" width="400" height="150"/>
    
  </div>

  <div class="col-span-1 ">
    <img src="resoses/images/fragrence4.jpeg" width="400" height="160"/>
  </div>
...
?>
 ...
 <div id="Projects"
    ...
    <div class="col-span-1 duration-500 bg-white shadow-md w-72 rounded-xl hover:scale-105 hover:shadow-xl">
        
    <a href="singleProductView.php?s=<?php echo $d["qty"] ?>"><img src="<?php echo $d["proimage_id"]; ?>"  alt="Product" class="object-cover h-80 w-72 rounded-t-xl" ></a>
            ...
            <div class="px-4 py-3 w-72">
                ...
                <div class="flex items-center">
                    <p class="my-3 text-lg font-semibold text-black cursor-auto">Rs.<?php echo $d["customer_price"]; ?>  &nbsp;<lable class="text-sm"> Available:<?php echo $d["qty"]; ?></lable> </p>
                    ...
                    <button class="ml-auto"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div class="col-sapn-2"><button class="w-full px-4 py-2 rounded-md bg-rose-200">Add to cart</button></div>
    ...
    <div class="flex mt-5 justify-content-center">
        <nav aria-label="Page navigation example">
            ...
            <ul class="flex gap-4 py-2 font-medium text-gray-600">
                ...
                <li class=""><a class="px-4 py-2 transition duration-300 ease-in-out rounded-full hover:bg-white hover:text-gray-600" <?php
